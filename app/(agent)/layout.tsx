...
export default async function AgentLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex flex-col h-full h-[100dvh] w-full bg-sand-light/10">
      <header className="px-6 py-3 bg-white border-b border-accent/5 flex items-center justify-between z-10 shadow-sm">
